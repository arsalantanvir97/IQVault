                ...
                <form action="">
                    <div class="row form-group">
                        <div class="col-12 col-lg-4 col-xl-3 col-xxl-3 align-self-center">
                            <label class="fw-light">First Name<span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-12 col-lg-4 col-xl-3 col-xxl-3 align-self-center">
                            <label class="fw-light">Last Name<span class="text-danger">*</span></label>
                        </div>
                        <div class="col-12 col-lg-8 col-xl-6 col-xxl-5">
                            <input type="text" class="form-control" value="Adams">
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-12 col-lg-4 col-xl-3 col-xxl-3 align-self-center">
                            <label class="fw-light">Email<span class="text-danger">*</span></label>
                        </div>
                        <div class="col-12 col-lg-8 col-xl-6 col-xxl-5">
                    ...
                    <div class="row form-group">
                        <div class="col-12 col-lg-4 col-xl-3 col-xxl-3 align-self-center">
                            <label class="fw-light">Phone No<span class="text-danger">*</span></label>
                        </div>
                        <div class="col-12 col-lg-8 col-xl-6 col-xxl-5">
                    ...
                    <div class="row detail-row">
                        <div class="col-12 mt-3">
                            <a href="profile.php" class="btn btn-blue text-uppercase px-5 me-3">Save Changes</a>
                            <a href="profile.php" class="btn btn-secondary text-uppercase px-5">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
