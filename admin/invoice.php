...
<section id="invoice-detail" class="inquiry-page">
        ...
        <div class="page-title mb-4">
            <div class="row">
                ...
                <div class="col-md-6 text-md-end">
                    <button type="button" class="btn add-btn orange-btn" data-bs-toggle="modal" data-bs-target=".generate-invoice">Add Invoice</button>
                </div>
            </div>
        </div>
                ...
                <table class="table dataTable px-2">
                    <thead>
                        <tr>
                            ...
                            <th class="sorting">Generated On</th>
                            <th class="sorting">Total Cost</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>ADCF</td>
                            <td>Web Service</td>
                            <td>03<span>/</span>02<span>/</span>2020</td>
                            <td><span>$</span>123</td>
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target=".complete-invoice"><i class="fa fa-eye"></i>View</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
