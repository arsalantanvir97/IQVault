                ...
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    <ul class="nav navbar-nav ms-auto justify-content-end">
                        <li class="dropdown dropdown-notification nav-item d-flex">
                            <a class="nav-link nav-link-label align-self-center" href="#" data-bs-toggle="dropdown" aria-expanded="true">
                                <i class="fas fa-bell"></i> <!-- <span class="badge badge-pill badge-default badge-danger badge-default badge-up">5</span> --> </a>
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-bs-toggle="dropdown">
                                ...
                                <div>
                                    <span class="user-name d-block">Mark Carson</span>
                        ...
                        <li class="nav-item d-none d-md-flex menu-toggle">
                            <a class="nav-link hidden-xs align-self-center" href="#"><i class="ft-menu"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
